...
# 
    ...
    plt.show()
    return dB_list, burst_time_list
...
#     file_name = file[:-1]
        ...
        for t in range (math.floor(((diff_move_db.shape[1]-time_co)/time_band) + 1)):
            ...
            try:
                dB_list, burst_time_list = radio_plot(diff_db_plot_sep, x_lims, Frequency_start, Frequency_end, Time_start, Time_end, date_OBs[:8], burst_type, detected_files, save_dir, width, Status_sep, time - time_band - time_co)
