...
year_list_1 = [20120101,20130101,20140101, 20170101,20190101]
year_list_2 = [20121231,20131231,20141231, 20171231,20191231]
...
y = func(final_xdata,0.007354,1.76)
ax.plot(final_xdata, y, '-', color = 'g', label = 'Mann et al., 1999', linewidth = 3.0)
...
ax.plot(final_xdata, y, '-', color = 'g', label = 'Morosan et al., 2015', linewidth = 3.0)

y = func(final_xdata,0.007354,1.76)
ax.plot(final_xdata, y, '-', color = 'k', label = 'Mann et al., 1999', linewidth = 3.0)
