...
def read_data(Parent_directory, file_name, move_ave, Freq_start, Freq_end):
    ...
    return diff_move_db, diff_db_min_med, min_db, Frequency_start, Frequency_end, resolution, epoch, freq_start_idx, freq_end_idx, Frequency, Status, date_OBs, RR, LL
...
# years = ['2013']
with open(Parent_directory+ '/solar_burst/Nancay/af_sgepss_analysis_data/RR_LL_antenna/antenna_RR_LL_all_freq_under5_'+str(date_in[0])+'_'+str(date_in[1])+'.csv', 'w') as f:
    ...
    #     for file in gen:
    #         file_name = file[:-1]
            diff_move_db, diff_db_min_med, min_db, Frequency_start, Frequency_end, resolution, epoch, freq_start_idx, freq_end_idx, Frequency, Status, date_OBs, RR, LL= read_data(Parent_directory, file_name, 3, 80, 10)
