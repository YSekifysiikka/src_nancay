...
def radio_plot(data_1, receiver_1, BG_1, data_2, receiver_2, BG_2, diff_db_plot_sep, x_lims, Frequency_start, Frequency_end, Time_start, Time_end, date_OBs):
    ...
    if not os.path.isdir(Parent_directory + '/solar_burst/Nancaywind_3/'+year + '/' + month):
        os.makedirs(Parent_directory + '/solar_burst/Nancaywind_3/'+year + '/' + month)
    filename = Parent_directory + '/solar_burst/Nancaywind_3/'+year + '/' + month + '/'+year+month+day+'_'+Time_start[0:2]+Time_start[3:5]+Time_start[6:8]+'_'+Time_end[0:2]+Time_end[3:5]+Time_end[6:8]+ '.png'
