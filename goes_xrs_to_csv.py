    ...
    for file in files:
        ...
        for datalist in datalists:
            ...
            if ((len(datalist_event[1][0:2]) == 2) & (len(datalist_event[2][0:2]) == 2) & (len(datalist_event[3][0:2]) == 2) & (len(datalist_event[1][2:4]) == 2) & (len(datalist_event[2][2:4]) == 2) & (len(datalist_event[3][2:4]) == 2)):
                if ((datalist_event[3][0] == 'S') or (datalist_event[3][0] == 'N') or (datalist_event[3][3] == 'W') or (datalist_event[3][3] == 'E')):
                    pass
                else:
...
Parent_directory = '/Volumes/GoogleDrive/マイドライブ/lab'
eventnum = -1
files = ["/Volumes/GoogleDrive/マイドライブ/lab/hinode_catalog/goes-xrs-report_2002.txt", "/Volumes/GoogleDrive/マイドライブ/lab/hinode_catalog/goes-xrs-report_2001.txt", "/Volumes/GoogleDrive/マイドライブ/lab/hinode_catalog/goes-xrs-report_2000.txt"]
with open(Parent_directory+ '/hinode_catalog/goes_xrs_2000_2002.csv', 'w') as f:
    w = csv.DictWriter(f, fieldnames=["Event number", "start", "peak", "end", "X-ray class"])
...
Parent_directory = '/Volumes/GoogleDrive/マイドライブ/lab'
eventnum = -1
files = ["/Volumes/GoogleDrive/マイドライブ/lab/hinode_catalog/goes-xrs-report_2004.txt"]
with open(Parent_directory+ '/hinode_catalog/goes_xrs_2004.csv', 'w') as f:
    w = csv.DictWriter(f, fieldnames=["Event number", "start", "peak", "end", "X-ray class"])
...
Parent_directory = '/Volumes/GoogleDrive/マイドライブ/lab'
eventnum = -1
files = ['/Volumes/GoogleDrive/マイドライブ/lab/hinode_catalog/Hinode Flare Catalogue.csv', Parent_directory+ '/hinode_catalog/goes_xrs_2004.csv', Parent_directory+ '/hinode_catalog/goes_xrs_2000_2002.csv', Parent_directory+ '/hinode_catalog/goes_xrs_1995_1997.csv']
# files = ['/Volumes/GoogleDrive/マイドライブ/lab/hinode_catalog/Hinode Flare Catalogue.csv', Parent_directory+ '/hinode_catalog/goes_xrs_2000_2002.csv', Parent_directory+ '/hinode_catalog/goes_xrs_1995_1997.csv']
with open(Parent_directory+ '/hinode_catalog/Hinode Flare Catalogue new_2.csv', 'w') as f:
