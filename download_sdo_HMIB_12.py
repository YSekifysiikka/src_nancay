...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 14 13:55:35 2021
...
def download_sdo_HMIB(date):
    ...
    for url_ in url_list:
        ...
        try:
            ...
            if pic_type == '1024_HMIB.jpg':
                HMIB_pic_list.append(href)
        except:
            pass
    url2 = getNearestValue(HMIB_pic_list, str_date + '_120000')
    
    directry='/Volumes/GoogleDrive/マイドライブ/lab/solar_pic/sdo_HMIB/'+yyyy+'/'+mm
