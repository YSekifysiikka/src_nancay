...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 15 13:42:13 2021
...
def monthly_analysis(DATE, FDATE):
        ...
        try:
            ...
            if len(y_factor) > 0:
                ...
                for i in range (len(y_factor)):
                    ...
                    velocity_real_1.append(2/numerical_diff_allen_velocity(factor_velocity, h_radio)/freq[i]*slope/29979245800)
    ...
    return obs_time, velocity_real_1, repeat_num
...
#             # print (SDATE)
#             sdate = int(str(SDATE.year)+str(SDATE.month).zfill(2)+str(SDATE.day).zfill(2))
#             EDATE = SDATE + relativedelta.relativedelta(months=1) - relativedelta.relativedelta(days=1)
#             edate = int(str(EDATE.year)+str(EDATE.month).zfill(2)+str(EDATE.day).zfill(2))
#             # year_list_1.append(sdate)
#             # year_list_2.append(edate)
#             print (sdate, '-', edate)
...
#         except:
#             print ('Plot error: ' + SDATE)
#         SDATE+= relativedelta.relativedelta(months=1)
...
#     month_velocities = []
#     for j in range(len(obs_time)):
#         if obs_time[j] >= date(int(str(date_in[0])[:4]), 1, 1)+relativedelta.relativedelta(months=i) and obs_time[j] <= date(int(str(date_in[0])[:4]), 1, 1)+ relativedelta.relativedelta(months=i+1) - relativedelta.relativedelta(days=1):
#             month_velocities.append(obs_velocity[j])
#             num += 1
#     if num >= 1:
#         sobs_time.append(date(int(str(date_in[0])[:4]), 1, 1) + relativedelta.relativedelta(months=i))
#         eobs_time.append(date(int(str(date_in[0])[:4]), 1, 1) + relativedelta.relativedelta(months=i+1) - relativedelta.relativedelta(days=1))
#         month_velocity_mean.append(np.mean(month_velocities))
#         month_velocity_std.append(np.std(month_velocities))
#         mobs_time.append(date(int(str(date_in[0])[:4]), 1, 15) + relativedelta.relativedelta(months=i))
